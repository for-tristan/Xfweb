...
/**
 * LogoLoop — React Bits infinite logo carousel.
 *
 * Smooth JS-animated loop with pause-on-hover, edge fade, and scale-on-hover.
 * Supports both React node logos (icons) and image src logos.
 *
...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    // Pause when off-screen — zero GPU cost when not visible
