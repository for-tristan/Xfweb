...
interface NavbarProps {
  ...
  user: any;
  activePage?: string; // 'home' | 'study' | 'dashboard' | 'courses' | 'services' | 'admin'
  ...
  return (
    ...
    >
      ...
      <ul className={`nav-links${mobileMenuOpen ? ' active' : ''}`} id="navLinks">
        ...
        <li><a href="/#projects" className={isActive('projects') ? 'active' : ''} onClick={(e) => { e.preventDefault(); scrollToSection('projects'); closeMobile(); }}>Projects</a></li>
        <li><a href="/#courses" className={isActive('courses') ? 'active' : ''} onClick={(e) => { e.preventDefault(); scrollToSection('courses'); closeMobile(); }}>Courses</a></li>
        ...
        <li><a href="/#team" className={isActive('team') ? 'active' : ''} onClick={(e) => { e.preventDefault(); scrollToSection('team'); closeMobile(); }}>Team</a></li>
