      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            ...
            <button onClick={onClose} style={{ background: 'none', border: 'none', color: 'var(--text-dim)', fontSize: 20, cursor: 'pointer', padding: 4 }}><i className="fa-solid fa-times" /></button>
          </div>
          ...
          {questions.map((qq, idx) => (
            <button
              ...
              style={{
                ...
                color: idx === currentQ ? 'var(--primary-red)' : answers[qq.id] !== undefined ? 'var(--success-color)' : 'var(--text-dim)',
              }}
            >
              {idx + 1}
            </button>
