  ...
  return (
    <div
      ...
      style={{
        ...
        background: isMobile ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.85)',
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <h3 style={{
            margin: 0, fontSize: isMobile ? 15 : 16, fontWeight: 700,
            ...
            {isMobile && mobileView === 'chat' && selectedFriend ? (
              <>
                ...
                <div style={{
                  ...
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: 'var(--primary-red)', fontSize: 11, fontWeight: 700,
                ...
                conversations.map((convo) => (
                  ...
                  >
                    <div style={{
                      ...
                      border: '1px solid rgba(220,20,60,0.2)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      color: 'var(--primary-red)', fontSize: 13, fontWeight: 700,
                      overflow: 'hidden', flexShrink: 0,
                    }}>
                      {convo.friend.avatar
                ...
                {!isMobile && (
                  <div style={{
                    ...
                    <div style={{
                      ...
                      border: '1px solid rgba(220,20,60,0.2)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      color: 'var(--primary-red)', fontSize: 12, fontWeight: 700,
                      overflow: 'hidden',
                    }}>
                      {selectedFriend.avatar
                        ? <img src={selectedFriend.avatar} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} />
                      ...
                      return (
                        ...
                        >
                          <div style={{
                            ...
                            background: isMine ? 'var(--primary-red)' : 'rgba(255,255,255,0.06)',
                ...
                >
                  <input
                    ...
                    style={{
                      ...
                      // Minimum 44px height on mobile for easy tapping
                      ...(isMobile ? { minHeight: 44 } : {}),
                      borderRadius: 8,
                      border: '1px solid var(--border-color, rgba(255,255,255,0.1))',
                      background: 'rgba(255,255,255,0.04)',
                      color: 'var(--text-light, #fff)',
                      fontSize: isMobile ? 16 : 13, // 16px prevents iOS auto-zoom on focus
                      fontFamily: "'Space Grotesk', sans-serif",
                      outline: 'none',
                      boxSizing: 'border-box',
                    }}
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: newMessage.trim() ? 'var(--primary-red)' : 'rgba(255,255,255,0.06)',
