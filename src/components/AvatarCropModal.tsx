      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            <i className="fas fa-crop-alt" style={{ color: 'var(--primary-red)', fontSize: 14 }} />
        ...
        <div style={{
          ...
          >
            {uploading ? (
              <><i className="fas fa-spinner fa-spin" style={{ marginRight: 8 }} />Processing...</>
            ) : (
              <><i className="fas fa-check" style={{ marginRight: 8 }} />Apply</>
            )}
          </button>
        </div>
      </div>
