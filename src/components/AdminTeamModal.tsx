            ...
            >
              ...
              >
                <div style={fieldColStyle}>
                  <label style={{ ...labelStyle }}>
                    Name <span style={{ color: 'var(--primary-red)' }}>*</span>
                  </label>
                  <input
                    type="text"
                    value={form.name}
                ...
                <div style={fieldColStyle}>
                  <label style={{ ...labelStyle }}>
                    Role <span style={{ color: 'var(--primary-red)' }}>*</span>
                  </label>
                  <input
                    type="text"
                    value={form.role}
              ...
              >
                ...
                <div style={fieldColStyle}>
                  ...
                  <input
                    ...
                    placeholder="fa-solid fa-user-tie"
                    style={inputStyle}
                  />
                </div>
              </div>
              ...
              >
                ...
                <button
                  ...
                  onMouseLeave={(e) => {
                    if (!saving) e.currentTarget.style.background = 'var(--primary-red)';
                  }}
                >
                  {saving ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: '1px solid var(--border-color, rgba(255,255,255,0.08))',
                        background: 'transparent',
                        color: deleteConfirmId === member.id ? 'var(--primary-red)' : 'var(--text-dim, #888)',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
