        ...
        >
          ...
          >
            <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', color: '#efefef', fontSize: 16, fontWeight: 700 }}>
              <i className="fas fa-certificate" style={{ color: 'var(--primary-red)', marginRight: 8 }} />
          ...
          <div style={{ padding: 24 }}>
            {loading ? (
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                <i className="fas fa-spinner fa-spin" style={{ fontSize: 32, color: 'var(--primary-red)', marginBottom: 16 }} />
              ...
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                <i className="fas fa-exclamation-triangle" style={{ fontSize: 32, color: 'var(--warning-color)', marginBottom: 16 }} />
