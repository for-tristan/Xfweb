        ...
        >
          ...
          >
            <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', color: '#efefef', fontSize: 16, fontWeight: 700 }}>
              <i className="fas fa-certificate" style={{ color: '#dc143c', marginRight: 8 }} />
          ...
          <div style={{ padding: 24 }}>
            {loading ? (
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                <i className="fas fa-spinner fa-spin" style={{ fontSize: 32, color: '#dc143c', marginBottom: 16 }} />
              ...
              <div ref={certRef} className="certificate-print-area" style={{ display: 'flex', justifyContent: 'center' }}>
                ...
                >
                  ...
                  {/* Decorative top line */}
                  <div style={{ width: 80, height: 2, background: '#dc143c', marginBottom: 20 }} />
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 28 }}>
                    <div style={{ width: 60, height: 1, background: '#dc143c' }} />
                  ...
                  <div style={{ width: 80, height: 2, background: '#dc143c', marginTop: 20 }} />
                </div>
              </div>
            ) : (
              <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                <i className="fas fa-exclamation-triangle" style={{ fontSize: 32, color: '#f59e0b', marginBottom: 16 }} />
