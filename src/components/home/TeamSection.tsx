...
/**
 * TeamSection — "Meet The Team" section.
 * Renders team members from the database (admin-managed).
 */
              ...
              <div key={m.id} className="v-team-card">
                ...
                {(m.linkedinUrl || m.githubUrl) && (
                  <div className="v-team-socials">
                    {m.linkedinUrl && (
                      <a href={m.linkedinUrl} target="_blank" rel="noopener noreferrer" style={{ position: 'relative', zIndex: 11 }}>
                        <i className="fa-brands fa-linkedin-in"></i>
                      </a>
                    )}
                    {m.githubUrl && (
                      <a href={m.githubUrl} target="_blank" rel="noopener noreferrer" style={{ position: 'relative', zIndex: 11 }}>
