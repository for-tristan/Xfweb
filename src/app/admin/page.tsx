              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {userModules.map(mod => {
                  ...
                  return (
                    ...
                    >
                      <i className={isLoading ? 'fa-solid fa-spinner fa-spin' : isUnlocked ? 'fa-solid fa-lock' : 'fa-solid fa-lock-open'} style={{ marginRight: 6, fontSize: 10 }}></i>
                ...
                >
                  <i className={unlockLoading === `${userId}-all` ? 'fa-solid fa-spinner fa-spin' : 'fa-solid fa-unlock'} style={{ marginRight: 6, fontSize: 10 }}></i>All
                </button>
              </div>
            </div>
          </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 16, flex: 1, minWidth: 250 }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 12, color: 'var(--text-dim)' }}>
                              Module: {t.moduleTitle} &middot; {t.questionCount} question{t.questionCount !== 1 ? 's' : ''} &middot; {t.attemptCount} attempt{t.attemptCount !== 1 ? 's' : ''} &middot; <span style={{ color: 'var(--primary-red)', fontWeight: 700 }}><i className="fa-solid fa-clock" style={{ marginRight: 4, fontSize: 10 }}></i>{t.timeLimit} min</span> &middot; Pass: {t.passingScore}%
                            </div>
                          </div>
                        </div>
                ...
                <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border-color)', padding: '32px 40px', borderRadius: 2, marginBottom: 24 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                    ...
                    <div>
                      ...
                      <input value={serviceForm.icon} onChange={e => setServiceForm(f => ({ ...f, icon: e.target.value }))} placeholder="fa-solid fa-cog" style={{ width: '100%', padding: '10px 14px', background: 'var(--input-bg)', border: '1px solid var(--border-color)', borderRadius: 2, color: 'var(--text-light)', fontSize: 13, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, outline: 'none' }} />
                    </div>
                    <div>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr auto', gap: 8, alignItems: 'end' }}>
                      ...
                      <div>
                        ...
                        <input value={newServiceFeature.icon} onChange={e => setNewServiceFeature(f => ({ ...f, icon: e.target.value }))} placeholder="fa-solid fa-check" style={{ width: '100%', padding: '8px 12px', background: 'var(--input-bg)', border: '1px solid var(--border-color)', borderRadius: 2, color: 'var(--text-light)', fontSize: 12, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, outline: 'none' }} />
                      </div>
              ...
              {showCourseForm && (
                <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border-color)', padding: '32px 40px', borderRadius: 2, marginBottom: 24 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                    ...
                    <div>
                      <label style={{ fontSize: 10, color: 'var(--text-dim)', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 4, display: 'block' }}>Icon (FA class)</label>
                      <input value={courseForm.icon} onChange={e => setCourseForm(f => ({ ...f, icon: e.target.value }))} placeholder="fa-solid fa-book" style={{ width: '100%', padding: '10px 14px', background: 'var(--input-bg)', border: '1px solid var(--border-color)', borderRadius: 2, color: 'var(--text-light)', fontSize: 13, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, outline: 'none' }} />
                    </div>
                    <div>
                      <label style={{ fontSize: 10, color: 'var(--text-dim)', textTransform: 'uppercase', letterSpacing: 2, marginBottom: 4, display: 'block' }}>Status</label>
