        ...
        <section className="course-hero" style={{ minHeight: 400 }}>
          <div className="hero-content" style={{ paddingTop: 180 }}>
            ...
            <div style={{ marginTop: 24, display: 'flex', gap: 16 }}>
              <Link href="/#courses" onClick={(e) => { e.preventDefault(); router.push('/'); setTimeout(() => document.getElementById('courses')?.scrollIntoView({ behavior: 'smooth' }), 300); }} className="btn btn-primary"><i className="fas fa-arrow-left" /> View All Courses</Link>
      ...
      <section className="course-hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-meta">
            <div className="meta-pill"><i className="fas fa-clock" /> {course.duration}</div>
            <div className="meta-pill"><i className="fas fa-signal" /> {course.level} Level</div>
            <div className="meta-pill"><i className="fas fa-tag" /> {course.price}</div>
          </div>
          <div className="breadcrumb" style={{ marginTop: 24 }}>
            <span style={{ color: 'var(--text-light)' }}>Home</span> <span>/</span> <span style={{ color: 'var(--text-light)' }}>Courses</span> <span>/</span> <span style={{ color: 'var(--text-light)' }}>{course.title.split('&')[0].trim()}</span>
          </div>
        </div>
      </section>
                ...
                <>
                  ...
                  <div className="what-learn">
                    {courseFeatures.map((feature, idx) => (
                      <div key={idx} className="learn-item"><i className="fas fa-check" /> {feature}</div>
                    ))}
                  </div>
                </>
              )}
                          ...
                          {moduleTests.length > 0 && (
                            <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid var(--border-color)' }}>
                              <h4 style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-light)', marginBottom: 12 }}>
                                <i className="fas fa-file-alt" style={{ color: 'var(--primary-red)', marginRight: 8 }}></i>Module Test{moduleTests.length > 1 ? 's' : ''}
                              </h4>
                              {moduleTests.map((t) => (
                                    ...
                                    <div>
                                      ...
                                      <div style={{ fontSize: 12, color: 'var(--text-dim)', marginTop: 4 }}>
                                        ...
                                        {t.hasCompleted && t.attempt && (
                                          <span style={{ marginLeft: 12, color: t.attempt.passed ? '#22c55e' : '#ef4444', fontWeight: 700 }}>
              ...
              {enrollment ? (
                ...
                <div className="enroll-form">
                  ...
                  <div className="enroll-features">
                    ...
                    <div className="feature-check"><i className="fas fa-check" /> {course.duration} of content</div>
