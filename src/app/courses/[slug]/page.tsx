      ...
      <section className="course-hero">
        ...
        <div className="hero-content">
          ...
          <div className="breadcrumb" style={{ marginTop: 24 }}>
            <Link href="/" style={{ color: 'var(--text-dim)' }}>Home</Link> <span>/</span> <Link href="/#courses" style={{ color: 'var(--text-dim)' }}>Courses</Link> <span>/</span> <span style={{ color: 'var(--text-light)' }}>{course.title}</span>
          </div>
        </div>
      </section>
