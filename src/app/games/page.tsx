  ...
  return (
    <>
      ...
      {!(loading || minLoading) && <div className="page-transition-enter">
        <section style={{ background: 'var(--black)', padding: '140px 24px 300px', position: 'relative', zIndex: 2, minHeight: '200vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
