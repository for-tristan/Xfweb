...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch tests', details: String(error) }, { status: 500 });
  }
}
...
export async function PUT(request: NextRequest) {
  ...
  if (action === 'unlock') {
    ...
    try {
      ...
      return NextResponse.json({ error: 'Failed to unlock test', details: String(createErr) }, { status: 500 });
    }
  ...
  if (action === 'lock') {
    ...
    try {
      ...
      return NextResponse.json({ error: 'Failed to lock test', details: String(deleteErr) }, { status: 500 });
    }
  ...
  return NextResponse.json({ test });
    ...
    return NextResponse.json({ error: 'Failed to update test', details: String(error) }, { status: 500 });
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Failed to delete test', details: String(error) }, { status: 500 });
  }
}
