      ...
      <div className="page-transition-enter">
        ...
        <section className="course-hero">
          ...
          <div className="hero-content">
            ...
            <p style={{ fontSize: 16, color: 'var(--text-dim)', maxWidth: 500, lineHeight: 1.7, marginTop: 16, fontFamily: "'Space Grotesk', sans-serif" }}>
              Track your study sessions, stay motivated with real-time stats, and compete with fellow learners on the leaderboard.
            </p>
          ...
          <div className="container-max">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32, maxWidth: 1200, margin: '0 auto' }}>
              ...
              <div className="reveal reveal-delay-1" style={{
                ...
                {/* Control Buttons */}
                <div style={{ display: 'flex', gap: 12, marginBottom: 24, marginTop: timerRunning ? 24 : 0 }}>
                  {!timerRunning ? (
                    <button
                      onClick={handleStart}
                      disabled={!user}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  <div style={{ background: 'var(--input-bg)', border: '1px solid var(--border-color)', borderRadius: 2, padding: 16 }}>
                    ...
                    <div style={{ fontFamily: "'Orbitron', sans-serif", fontSize: 20, fontWeight: 700, color: 'var(--text-light)' }}>
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><Link href="/services/software-dev">Software Dev</Link></li>
