        ...
        <section className="course-hero">
          ...
          <div className="hero-content">
            ...
            <div className="hero-meta" style={{ marginTop: 24 }}>
              <div className="meta-pill"><i className="fa-solid fa-trophy" /> Leaderboard</div>
              <div className="meta-pill"><i className="fa-solid fa-chart-line" /> Weekly Stats</div>
            </div>
              ...
              <div className="reveal reveal-delay-1 study-card" style={{
                ...
                <div className="study-timer-padding" style={{
                  ...
                  <div className="study-timer-display" style={{
                    fontFamily: "'Orbitron', sans-serif", fontSize: isMobile ? 40 : 80, fontWeight: 900,
