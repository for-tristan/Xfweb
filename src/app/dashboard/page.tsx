...
function ProgressBar({ pct, height = 6 }: { pct: number; height?: number }) {
  ...
  const color = clamped === 100 ? 'var(--success-color)' : clamped >= 50 ? 'var(--primary-red)' : 'var(--warning-color)';
  return (
...
export default function DashboardPage() {
  ...
  const Skeleton = ({ w, h }: { w: string; h: string }) => (
    <div style={{ width: w, height: h, borderRadius: 2, background: 'var(--input-bg)', animation: 'skeleton-pulse 1.5s ease-in-out infinite' }} />
  );
                      ...
                      >
                        <div style={{
                          ...
                          <i className={`fas ${isComplete ? 'fa-check' : 'fa-book'}`}
                            style={{ fontSize: 13, color: isComplete ? 'var(--success-color)' : 'var(--primary-red)' }}
                          />
                        </div>
                        ...
                        {isComplete && (
                          ...
                          >
                            <i className="fas fa-download" style={{ fontSize: 10, color: 'var(--success-color)' }} />
                          </a>
                        )}
                      </Link>
                    );
                ...
                <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 280px', gap: isMobile ? 20 : 28 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {[
                      ...
                      { label: 'This Week', value: formatDuration(studyStats?.weekSeconds || 0), icon: 'fa-calendar-week', color: 'var(--primary-red)' },
