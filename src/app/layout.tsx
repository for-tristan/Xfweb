...
export const metadata: Metadata = {
  title: { default: 'X Foundry' },
  description: 'The best way to predict the future is to create it.',
  keywords: ['AI', 'machine learning', 'software development', 'tech education', 'web development', 'X.Foundry'],
  ...
  return (
    <html lang="en" suppressHydrationWarning className="dark" data-theme="dark">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;600;700;900&family=Space+Grotesk:wght@300;400;500;600;700&display=swap"
          rel="stylesheet"
        />
        <link
          rel="stylesheet"
