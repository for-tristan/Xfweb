...
const availableCourses: Course[] = [
  {
    id: 'ml-bootcamp',
    name: 'ML Engineer Bootcamp',
    category: 'Advanced Course',
    description: '8-week comprehensive program from ML fundamentals to production-ready AI systems.',
    level: 'Advanced',
    duration: '8 Weeks',
    price: 'Free',
    icon: 'fas fa-brain',
    features: ['8 weeks structured content', 'Hands-on projects', 'Certificate of completion', 'Discord community access', 'Lifetime access'],
  },
  {
    id: 'linux-basics',
    name: 'Linux Basics & Customization',
    category: 'Intermediate Course',
    description: 'Master Linux from command-line basics to advanced Arch Linux and Hyprland customization.',
    level: 'Intermediate',
    duration: '4 Weeks',
    price: 'Free',
    icon: 'fas fa-terminal',
    features: ['4 weeks of content', 'Video tutorials', 'Config files included', 'Discord community', 'Lifetime access'],
  },
];

const servicePageMap: Record<string, string> = {
  'ai-ml': '/services/ai-ml',
  'software-dev': '/services/software-dev',
  'education': '/services/training',
};

const courseModules: Record<string, string[]> = {
  'ml-bootcamp': [
    'Introduction to ML & Python Setup',
...
useEffect(() => {
  ...
  const handleEnrollSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = await res.json();
      if (res.ok) { toast({ title: 'Request Submitted!', description: `Your enrollment request for ${enrollCourse.name} has been submitted. An admin will review it shortly.` }); setEnrollModalOpen(false); loadEnrollments(); }
  ...
  const handleCancelEnrollment = async (enrollmentId: string) => {
    ...
    try {
      ...
      const data = await res.json();
      if (res.ok) { toast({ title: 'Enrollment Cancelled', description: 'Your enrollment request has been cancelled' }); loadEnrollments(); }
  ...
  const servicesData: Record<string, { icon: string; title: string; description: string; features: string[]; link: string }> = {
    'ai-ml': {
      icon: 'fas fa-brain',
      title: 'AI & Machine Learning',
      description: 'We develop intelligent systems powered by state-of-the-art machine learning algorithms, deep learning models, and neural networks. Our team specializes in building production-ready AI solutions that are tailored to your specific business needs, from natural language processing and computer vision to predictive analytics and recommendation engines.',
      features: ['Custom ML Model Development', 'Natural Language Processing (NLP)', 'Computer Vision Solutions', 'Predictive Analytics & Data Pipeline', 'AI Integration into Existing Systems', 'Model Training, Fine-tuning & Deployment'],
      link: 'https://github.com/for-tristan/JackAi',
    },
    'software-dev': {
      icon: 'fas fa-code',
      title: 'Custom Software Development',
      description: 'End-to-end software development from concept to deployment. We build web applications, mobile apps, APIs, and enterprise solutions using modern tech stacks. Our agile development process ensures high-quality deliverables that scale with your business requirements.',
      features: ['Full-Stack Web Applications', 'Mobile App Development (iOS & Android)', 'REST & GraphQL API Development', 'Cloud Architecture & Deployment', 'Database Design & Optimization', 'CI/CD Pipeline Setup & DevOps'],
      link: 'https://github.com/for-tristan/Real-time-web-view',
    },
    'education': {
      icon: 'fas fa-graduation-cap',
      title: 'Tech Education & Training',
      description: 'Comprehensive training programs, workshops, and certification courses in AI, cybersecurity, cloud computing, and software engineering. Our courses are designed by industry experts and focus on practical, hands-on learning that prepares you for real-world challenges.',
      features: ['ML & AI Bootcamp Programs', 'Linux System Administration', 'Cybersecurity Fundamentals', 'Cloud Computing (AWS, GCP, Azure)', 'Software Engineering Best Practices', 'Corporate Team Training Programs'],
      link: '#courses',
    },
  };
  ...
  return (
    <>
      ...
      <section className="section services" id="services">
        ...
        <div className="services-grid">
          <div className="service-card reveal reveal-delay-1" style={{ cursor: 'pointer' }} onClick={() => router.push('/services/ai-ml')}>
            <span className="service-number">01</span>
            <i className="fas fa-brain service-icon"></i>
            <h3>AI &amp; Machine Learning</h3>
            <p>Develop intelligent systems powered by state-of-the-art machine learning algorithms, deep learning models, and neural networks tailored to your business needs.</p>
            <span className="service-link">Learn More <i className="fas fa-arrow-right"></i></span>
          </div>
          <div className="service-card reveal reveal-delay-2" style={{ cursor: 'pointer' }} onClick={() => router.push('/services/software-dev')}>
            <span className="service-number">02</span>
            <i className="fas fa-code service-icon"></i>
            <h3>Custom Software Dev</h3>
            <p>End-to-end software development from concept to deployment. Web apps, mobile applications, APIs, and enterprise solutions built with modern tech stacks.</p>
            <span className="service-link">Learn More <i className="fas fa-arrow-right"></i></span>
          </div>
          <div className="service-card reveal reveal-delay-3" style={{ cursor: 'pointer' }} onClick={() => router.push('/services/training')}>
            <span className="service-number">03</span>
            <i className="fas fa-graduation-cap service-icon"></i>
            <h3>Tech Education &amp; Training</h3>
            <p>Comprehensive training programs, workshops, and certification courses in AI, cybersecurity, cloud computing, and software engineering.</p>
            <span className="service-link">Learn More <i className="fas fa-arrow-right"></i></span>
          </div>
        </div>
      </section>
      ...
      <section className="section projects" id="projects">
        ...
        <div className="projects-filter reveal">
          ...
          <button className={`filter-btn${projectFilter === 'ai' ? ' active' : ''}`} onClick={() => setProjectFilter('ai')}>AI</button>
          <button className={`filter-btn${projectFilter === 'web' ? ' active' : ''}`} onClick={() => setProjectFilter('web')}>Apps</button>
          <button className={`filter-btn${projectFilter === 'linux' ? ' active' : ''}`} onClick={() => setProjectFilter('linux')}>Linux</button>
        </div>
      ...
      <section className="section courses" id="courses">
        ...
        <div className="section-header reveal">
          ...
          <h2 className="section-title">Tech Courses &amp; Programs</h2>
          <div className="section-divider"></div>
          <p className="section-desc" style={{ marginTop: 22 }}>
            Master cutting-edge technologies with our expert-led programs.
          </p>
        </div>

        <div className="courses-container">
          <div className="course-card reveal">
            <div className="course-image" style={{ cursor: 'pointer' }} onClick={() => router.push('/courses/ml-bootcamp')}>
              <i className="fas fa-brain"></i>
              <span className="course-level">Advanced</span>
            </div>
            <div className="course-content">
              <span className="course-category">Artificial Intelligence</span>
              <h3 style={{ cursor: 'pointer' }} onClick={() => router.push('/courses/ml-bootcamp')}>Complete Machine Learning Engineer Bootcamp</h3>
              <p>Comprehensive 8-week program covering deep learning, NLP, and computer vision. Build production-ready AI systems from scratch.</p>
              <div className="course-meta">
                <span className="meta-item"><i className="fas fa-clock"></i> 8 Weeks</span>
                <span className="meta-item"><i className="fas fa-users"></i> Enrolling Now</span>
              </div>
              <div className="course-modules">
                <span className="module-tag">Python</span>
                <span className="module-tag">TensorFlow</span>
                <span className="module-tag">NumPy</span>
                <span className="module-tag">Pandas</span>
              </div>
              <div className="course-footer" style={{ justifyContent: 'flex-end' }}>
                <button className="btn btn-primary" style={{ fontSize: 11, padding: '10px 20px', border: 'none' }} onClick={() => openEnrollModal(availableCourses[0])}>
                  {enrolledCourses.includes('ml-bootcamp') ? '✓ Enrolled' : 'Enroll Now →'}
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="course-card reveal">
            <div className="course-image" style={{ cursor: 'pointer' }} onClick={() => router.push('/courses/linux-basics')}>
              <i className="fas fa-shield-virus"></i>
              <span className="course-level">Intermediate</span>
            </div>
            <div className="course-content">
              <span className="course-category">Linux Systems</span>
              <h3 style={{ cursor: 'pointer' }} onClick={() => router.push('/courses/linux-basics')}>Linux Basics and Customization</h3>
              <p>Learn the fundamentals of Linux System administration and customization techniques for power users.</p>
              <div className="course-meta">
                <span className="meta-item"><i className="fas fa-clock"></i> 4 Weeks</span>
                <span className="meta-item"><i className="fas fa-users"></i> Enrolling Now</span>
              </div>
              <div className="course-modules">
                <span className="module-tag">Arch Linux</span>
                <span className="module-tag">Wayland</span>
                <span className="module-tag">Hyprland</span>
              </div>
              <div className="course-footer" style={{ justifyContent: 'flex-end' }}>
                <button className="btn btn-primary" style={{ fontSize: 11, padding: '10px 20px', border: 'none' }} onClick={() => openEnrollModal(availableCourses[1])}>
                  {enrolledCourses.includes('linux-basics') ? '✓ Enrolled' : 'Enroll Now →'}
                </button>
              </div>
            </div>
          </div>
      ...
      <section className="section" id="faq" style={{ background: 'var(--black)' }}>
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 2 }}>
          {[
            ...
            { q: 'How do I contact support?', a: 'You can reach us through the Contact form on our website, via email at xfoundationcom@gmail.com, or through our Discord community. We also have an AI assistant (XAI) available on every page to answer quick questions.' },
          ].map((faq, i) => (
      ...
      <section className="section team" id="team">
        ...
        <div className="section-header reveal">
          ...
          <div className="section-divider"></div>
          <p className="section-desc" style={{ marginTop: 22 }}>
            The visionary behind X-Foundry
          </p>
        </div>
        ...
        <div className="team-grid">
          <div className="team-card reveal reveal-delay-1">
            ...
            <h3>Marwan Montaser</h3>
            <span className="team-role">CEO &amp; Founder</span>
            <p className="team-bio">Jack Voice Assistant Creator, senior Computer Science / AI engineer. Passionate about democratizing AI technology.</p>
            <div className="team-socials">
              <a href="https://www.linkedin.com/in/marwan-montaser-067054387/" target="_blank" rel="noopener noreferrer" className="social-link" style={{ position: 'relative', zIndex: 11 }}><i className="fab fa-linkedin-in"></i></a>
              <a href="https://github.com/for-tristan" target="_blank" rel="noopener noreferrer" className="social-link" style={{ position: 'relative', zIndex: 11 }}><i className="fab fa-github"></i></a>
            </div>
          </div>
        </div>
      </section>
            ...
            <ul className="info-list">
              ...
              <li className="info-item">
                ...
                <div className="info-text">
                  ...
                  <p>Sun - Thu: 9:00 AM - 6:00 PM EET</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a href="https://www.linkedin.com/in/marwan-montaser-067054387/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin-in"></i></a>
              <a href="https://github.com/for-tristan" target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
              <a href="https://discord.gg/TVRxJg3rcN" target="_blank" rel="noopener noreferrer"><i className="fab fa-discord"></i></a>
            </div>
          </div>
          ...
          <div className="footer-column">
            <h4>Services</h4>
            <ul className="footer-links">
              <li><a href="#services" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>AI &amp; ML</a></li>
              <li><a href="#services" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>Software Dev</a></li>
              <li><a href="#services" onClick={(e) => { e.preventDefault(); scrollToSection('services'); }}>Training</a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h4>Contact</h4>
      ...
      {/* ═══════════════════════════════════════════════════
          SERVICE DETAIL MODAL
          ═══════════════════════════════════════════════════ */}
      {serviceModal && servicesData[serviceModal] && (
        <div className="auth-modal-overlay active" onClick={(e) => { if (e.target === e.currentTarget) setServiceModal(null); }}>
          <div className="auth-modal" style={{ maxWidth: 640 }}>
            <div className="auth-modal-header">
              <h2 style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <span style={{ width: 40, height: 40, background: 'rgba(220,20,60,0.1)', border: '1px solid rgba(220,20,60,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 8 }}>
                  <i className={servicesData[serviceModal].icon} style={{ color: 'var(--primary-red)', fontSize: 16 }}></i>
                </span>
                {servicesData[serviceModal].title}
              </h2>
            ...
            <div className="auth-modal-body" style={{ padding: '28px 32px' }}>
              <p style={{ color: 'var(--text-dim)', fontSize: 14, lineHeight: 1.8, marginBottom: 24 }}>{servicesData[serviceModal].description}</p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 28 }}>
                {servicesData[serviceModal].features.map((f, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', background: 'var(--input-bg)', border: '1px solid var(--border-color)', borderRadius: 6 }}>
                    <i className="fas fa-check" style={{ color: 'var(--primary-red)', fontSize: 11 }}></i>
                    <span style={{ fontSize: 13, color: 'var(--text-light)', fontWeight: 600 }}>{f}</span>
                  </div>
                ))}
              </div>
              <div style={{ display: 'flex', gap: 12 }}>
                <a
                  href={servicesData[serviceModal].link.startsWith('#') ? servicesData[serviceModal].link : undefined}
                  onClick={servicesData[serviceModal].link.startsWith('#') ? (e) => { e.preventDefault(); setServiceModal(null); scrollToSection(servicesData[serviceModal].link.replace('#', '')); } : undefined}
                  target={servicesData[serviceModal].link.startsWith('#') ? undefined : '_blank'}
                  rel={servicesData[serviceModal].link.startsWith('#') ? undefined : 'noopener noreferrer'}
                  className="btn btn-primary"
                  style={{ textDecoration: 'none', fontSize: 12, padding: '12px 24px' }}
                >
                  {serviceModal === 'education' ? 'View Courses' : 'View Project'} <i className="fas fa-arrow-right"></i>
                </a>
              ...
              {dashTab === 'profile' && (
                <div style={{ maxWidth: 480, margin: '0 auto' }}>
                  ...
                  <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid var(--border-color)' }}>
                    <button
                      onClick={async () => {
                        if (!confirm('Are you sure you want to delete your account? This action is PERMANENT and cannot be undone. All your data, enrollments, messages, and progress will be lost.')) return;
                        if (!confirm('FINAL WARNING: Type OK to confirm deletion.')) return;
                        try {
