              ...
              <div key={course.id} className="course-card reveal">
                ...
                <div className="course-content">
                  ...
                  <div className="course-meta">
                    ...
                    <span className="meta-item"><i className="fas fa-users"></i> {course.enrollmentCount != null ? `${course.enrollmentCount} enrolled` : 'Enrolling Now'}</span>
                  </div>
                      ...
                      return (
                        <div key={course.id} style={{ background: 'var(--card-bg)', border: '1px solid var(--border-color)', padding: 24 }}>
                          ...
                          <button className="submit-btn" disabled={isApproved || isPending} onClick={() => openEnrollModal(course)} style={{ padding: '10px 0', fontSize: 11, letterSpacing: 2, marginTop: 0, opacity: (isApproved || isPending) ? 0.5 : 1 }}>
                            {isApproved ? '✓ Enrolled' : isPending ? '⏳ Pending...' : isDeclined ? <><i className="fas fa-redo"></i> Re-apply</> : <><i className="fas fa-plus"></i> Enroll Now</>}
                          </button>
                        </div>
                      );
                    })}
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                              ...
                              <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                                  ...
                                  {enr.experienceLevel && <span style={{ fontSize: 11, color: 'var(--text-dim)' }}><i className="fas fa-signal" style={{ marginRight: 4, fontSize: 10 }}></i>{enr.experienceLevel}</span>}
                                </div>
                              </div>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
